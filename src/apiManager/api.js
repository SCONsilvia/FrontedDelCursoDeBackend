const headers = (method="GET",body=undefined,contentType='application/json')=>{
    return {
        ...
        headers: {
        'Access-Control-Allow-Origin': process.env.REACT_APP_ORIGIN || "http://localhost:3000",// (cooki) aqui va la ruta del origen donde esta montada la pagina web
...
const server = process.env.REACT_APP_SERVER || "http://localhost:8080"

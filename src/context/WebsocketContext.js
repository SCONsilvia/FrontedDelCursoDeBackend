...
const socket = io(process.env.REACT_APP_SOCKET || "ws://localhost:8080", {//para que funcione en localhost "ws://localhost:8080" y en servidor real "wss://materialistic-tender-agreement.glitch.me/"
